...
function afficheInfoCarte(idCarte)
{
	...
	if(MZ_getValue(numTroll+".capitan."+idCarte+".signe") !=null)
	{
		var signes = MZ_getValue(numTroll+".capitan."+idCarte+".signe").split(";");
...
function infoRecherche()
{
	...
	if(MZ_getValue(numTroll+".capitan."+idCarte+".signe") == null)
	{
		...
		if(!infoYCoin)
			y = -y;
		MZ_setValue(numTroll+".capitan."+idCarte+".signe",signe(x)+";"+signe(y));
	}
