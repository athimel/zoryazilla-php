...
try
{
	...
	if (document.getElementById("tags").value == "zztags") MZ_setValue("TAGSURL",ZZDB+"/Tags/ZZTags.csv"); else if (document.getElementById("tags").value == "default")
	{
...
if (MZ_getValue("TAGSURL") != "" && MZ_getValue("TAGSURL") != null) {
	var c = MZ_getValue("TAGSURL"); if(c==ZZDB+"/Tags/ZZTags.csv") document.getElementsByName("tags")[0].value = "zztags"; else
