...
else if(lien.indexOf("/mountyhall/MH_Play/Play_equipement.php?as_CurSect=follo") != -1){
// if(true) {
	var suivants = new Array();
	var page_trajet = "suivants";
	var nb_liste = 0;
...
else if((lien.indexOf("/mountyhall/MH_Lieux/Lieu_Description.php") != -1) && (corps_page.innerHTML.indexOf("Portail : Portail de T") != -1)) {
// else if(true) {
	var sortie = null;
	var page_trajet = "teleport";
	haut = document;
	ini_teleport();
}
