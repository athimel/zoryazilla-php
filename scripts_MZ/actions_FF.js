...
function catchBOTAttaque() {     
	if (document.URL.indexOf("Messagerie/ViewMessageBot.php")>=0) {
		...
		if ((messageTitle.indexOf("[MountyHall] Résultat de Combat - Attaquant") != -1)||
		    ...
		    else if (messageTitle.indexOf("(Attaque Précise)") != -1) var ATTAQUE="IdComp9";  
		    else if (messageTitle.indexOf("(Botte Secrète)") != -1) var ATTAQUE="IdComp1";  
		    else if (messageTitle.indexOf("(Frénésie)") != -1) var ATTAQUE="IdComp7";  
		    ...
		    else if (messageTitle.indexOf("(Piège à Feu)") != -1) var ATTAQUE="IdComp15";  
		    else if (messageTitle.indexOf("(Balayage)") != -1) var ATTAQUE="IdComp6";  
		    else if (messageTitle.indexOf("(Siphon des Âmes)") != -1) var ATTAQUE="IdSort14";  
			else {
			...
			// recherche du niveau de la Cible => impossible sur le BOT, le troll a pût changer de niveau
			//...
...
function dispatch() {
	if (isPage('MH_Play/Actions')) {
		...
		if (messageTitle.indexOf('Résultat de Combat') != -1 && messageTitle.indexOf('sur') != -1) {
			getLevel();
			traiteRM();
			}
		else if (messageTitle.indexOf('Résultat du pouvoir') != -1
				|| messageTitle.indexOf('Résultat de Combat') != -1)
			traiteMM();
