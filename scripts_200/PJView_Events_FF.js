...
function putEventTroll() {
	...
	//=== partie commune à infomonstres_FF.js (sauf depuis prise ne compte des profils avancé)
	...
	for (var i=i_events;i<x_events.length;i+=2) {
	  ...
	  if ((DescEvt) && (DescEvt.slice(DescEvt.indexOf('\(')+2, DescEvt.indexOf('\)')-1)==evtTroll)) {    // 		différence 	 infomonstres_FF.js  et PJView_Events.js  (control supplémentaire)
...
// détection des profil étendu, la structure des tables est différente pour ceux là!!!
